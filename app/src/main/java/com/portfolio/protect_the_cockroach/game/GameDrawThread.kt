...
class GameDrawThread(surfaceHolder: SurfaceHolder, resources: Resources, widthScreen: Double, heightScreen: Double) : Thread() {

    var runFlag = false

    private var immovableRenderingManager: ImmovableRenderingManager = ImmovableRenderingManager(widthScreen, heightScreen, resources)
    private var dynamicRenderingManager: DynamicRenderingManager     = DynamicRenderingManager(widthScreen, heightScreen, resources)
